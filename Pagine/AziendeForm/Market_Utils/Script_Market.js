...
Compere[13] = parseInt(document.getElementById("Scarpe_Balenciaga").value);
Compere[14] = parseInt(document.getElementById("Scarpe_Dr_Martens").value);
Compere[15] = parseInt(document.getElementById("Scarpe_Fila").value);
Compere[16] = parseInt(document.getElementById("Scarpe_Golden_Goose").value);
Compere[17] = parseInt(document.getElementById("Scarpe_Golf_Le_Fleur").value);
Compere[18] = parseInt(document.getElementById("Scarpe_Lelly_Kelly").value);
Compere[19] = parseInt(document.getElementById("Porta_Pregiata_1").value);
Compere[20] = parseInt(document.getElementById("Porta_Pregiata_2").value);
Compere[21] = parseInt(document.getElementById("Porta_Pregiata_3").value);
Compere[22] = parseInt(document.getElementById("Porta_Pregiata_4").value);
Compere[23] = parseInt(document.getElementById("Cuffie_Gaming").value);
Compere[24] = parseInt(document.getElementById("Quadro").value);
Compere[25] = parseInt(document.getElementById("Nintendo_Switch").value);
Compere[26] = parseInt(document.getElementById("Televisore").value);
Compere[27] = parseInt(document.getElementById("Orologio_Antico").value);
Compere[28] = parseInt(document.getElementById("Blocco_di_Lapislazzuli").value);
Compere[29] = parseInt(document.getElementById("Blocco_di_Diamante").value);
Compere[30] = parseInt(document.getElementById("Blocco_di_Smeraldo").value);
Compere[31] = parseInt(document.getElementById("Giradischi_Antico").value);
Compere[32] = parseInt(document.getElementById("Mazza_da_Collezione").value);
...
Compere[40] = parseInt(document.getElementById("Zaini_Calcio_Serie_A").value);
Compere[41] = parseInt(document.getElementById("Zaino_Lelly_Kelly").value);
Compere[42] = parseInt(document.getElementById("Zaino_Trapstar").value);
Compere[43] = parseInt(document.getElementById("Zaino_Nike").value);
Compere[44] = parseInt(document.getElementById("Zaino_Lanvin").value);
Compere[45] = parseInt(document.getElementById("Zaino_Supreme").value);
Compere[46] = parseInt(document.getElementById("Zaino_Gucci").value);
Compere[47] = parseInt(document.getElementById("Cappello").value);
Compere[48] = parseInt(document.getElementById("Pettorina").value);
Compere[49] = parseInt(document.getElementById("Pantaloni").value);
Compere[50] = parseInt(document.getElementById("Piedini").value);
